...
from FlameMusic import BOT_NAME, BOT_USERNAME
from FlameMusic.config import GROUP, CHANNEL

def play_markup(videoid, user_id):
    buttons = [
        [
            InlineKeyboardButton(text="ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/AnjelUpdates"),
...
def search_markup(
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="¹", callback_data=f"FlameMusic2 {ID1}|{duration1}|{user_id}"
            ),
            InlineKeyboardButton(
                text="²", callback_data=f"FlameMusic2 {ID2}|{duration2}|{user_id}"
            ),
            InlineKeyboardButton(
                text="³", callback_data=f"FlameMusic2 {ID3}|{duration3}|{user_id}"
            ),
        ],
        [
            InlineKeyboardButton(
                text="⁴", callback_data=f"FlameMusic2 {ID4}|{duration4}|{user_id}"
            ),
            InlineKeyboardButton(
                text="⁵", callback_data=f"FlameMusic2 {ID5}|{duration5}|{user_id}"
            ),
        ],
...
def search_markup2(
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="⁶", callback_data=f"FlameMusic2 {ID6}|{duration6}|{user_id}"
            ),
            InlineKeyboardButton(
                text="⁷", callback_data=f"FlameMusic2 {ID7}|{duration7}|{user_id}"
            ),
            InlineKeyboardButton(
                text="⁸", callback_data=f"FlameMusic2 {ID8}|{duration8}|{user_id}"
            ),
        ],
        [
            InlineKeyboardButton(
                text="⁹", callback_data=f"FlameMusic2 {ID9}|{duration9}|{user_id}"
            ),
            InlineKeyboardButton(
                text="¹⁰", callback_data=f"FlameMusic2 {ID10}|{duration10}|{user_id}"
            ),
        ],
        [
...
start_keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                "📚 ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ 📚", url="https://t.me/Flame_Updates/2"
            )
        ],
...
play_list_keyboard = InlineKeyboardMarkup( 
            [
                [
                    InlineKeyboardButton(
                        "➕ ᴜsᴇʀ ᴘʟᴀʏʟɪst", callback_data="P_list"
                    ),
                    InlineKeyboardButton(
                        "➕ ɢʀᴏᴜᴘ ᴘʟᴀʏʟɪst", callback_data="G_list"
                    )
                ],
                [
                    InlineKeyboardButton(
...
def start_pannel():
    ...
    if not CHANNEL and GROUP:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    text="✨ sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/GodOfAnjelsupport"
                ),
            ],
        ]
        return f"🎛  **This is {BOT_NAME}*", buttons
    if CHANNEL and not GROUP:
        buttons = [
            ...
            [
                InlineKeyboardButton(
                    text="✨ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/Anjelupdates"
                ),
            ],
        ]
        return f"🎛  **This is {BOT_NAME}**", buttons
